                ...
                <Carousel :settings="settings" :breakpoints="breakpoints">
                    <Slide class="swiper-slide" v-for="(category, index) in categories" :key="category"
                        ...
                        <router-link v-if="index === 0" to="#" @click.prevent="allCategory"
                            class="swiper-slide w-28 flex flex-col items-center text-center gap-4 py-4 px-3 rounded-lg border-b-2 border-transparent transition hover:bg-primary-light hover:border-primary bg-white">
    ...
    <div
        ...
        <div class="p-4">
            ...
            <div class="flex gap-2  mb-3">
                <vue-select class="db-field-control w-full flex-auto text-sm rounded-lg appearance-none text-heading border-[#D9DBE9]"
        ...
        <div class="p-4">
            <div class="flex h-[38px]" v-if="carts.length > 0">
                ...
                <input v-on:keypress="floatNumber($event)" v-model="discount" type="text" :placeholder="$t('label.add_discount')"
